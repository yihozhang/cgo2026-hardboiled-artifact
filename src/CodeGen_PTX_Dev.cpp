...
void CodeGen_PTX_Dev::init_module() {
    ...
    Intrinsic ptx_intrins[] = {
        ...
        {"wmma.store.d.sync.aligned.row.m32n8k16.f16.p3i32", Int(32), "adapted.llvm.nvvm.wmma.m32n8k16.store.d.row.stride.f16.p3i32", {Handle(), Float(32, 4), Int(32), Int(32)}, true},
        ...
        {"wmma.store.d.sync.aligned.row.m8n32k16.f32.p3i32", Int(32), "adapted.llvm.nvvm.wmma.m8n32k16.store.d.row.stride.f32.p3i32", {Handle(), Float(32, 8), Int(32), Int(32)}, true},
        {"wmma.store.d.sync.aligned.row.m8n32k16.f16.p3i32", Int(32), "adapted.llvm.nvvm.wmma.m8n32k16.store.d.row.stride.f16.p3i32", {Handle(), Float(32, 4), Int(32), Int(32)}, true},
        {"wmma.mma.sync.aligned.row.row.m8n32k16.f32.f32", Float(32, 8), "adapted.llvm.nvvm.wmma.m8n32k16.mma.row.row.f32.f32", {Int(32, 8), Int(32, 8), Float(32, 8)}, true},
        {"wmma.mma.sync.aligned.row.row.m8n32k16.f16.f16", Float(32, 4), "adapted.llvm.nvvm.wmma.m8n32k16.mma.row.row.f16.f16", {Int(32, 8), Int(32, 8), Float(32, 4)}, true},
